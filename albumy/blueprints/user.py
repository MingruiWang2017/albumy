...
from albumy.utils import redirect_back, generate_token, validate_token, flash_errors
...
def upload_avatar():
    ...
    if form.validate_on_submit():
        ...
        filename = avatars.save_avatar(image)  # 根据配置保存图片，并返回文件名
...
@fresh_login_required  # 需要用户处于fresh状态
def change_password():
